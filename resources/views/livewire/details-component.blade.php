        ...
        <div class="row">
                                            ...
                                            <div id="respond" class="comment-respond"> 
                                                ...
                                                <form action="#" method="post" id="commentform" class="comment-form" novalidate="">
                                                    <p class="comment-notes">
                                                        <span id="email-notes">Su dirección de correo electrónico no será publicada.</span> Required fields are marked <span class="required">*</span>
                                                    </p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                        ...
                        <ul class="our-services">
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        <b class="title">Especial Oferta</b>
                                        <span class="subtitle">¡Obten un Regalo!</span>
                                        <p class="desc">Lorem Ipsum is simply dummy text of the printing...</p>
                                    </div>
                                </a>
                            </li>
                ...
                <div class="widget mercado-widget widget-product">
                    ...
                    <div class="widget-content">
                        <ul class="products">
                            {{-- Inicio de bucle de productos randoms --}}
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        <a href="{{route('product.details',['slug'=>$p_product->slug])}}" title="{{$p_product->name}}" class="product-name">{{$p_product->name}}<span></span></a>
                ...
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            {{-- Bucle de los productos relativos --}}
