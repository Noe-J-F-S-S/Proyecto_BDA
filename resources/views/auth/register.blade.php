							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST">
									...
									<fieldset class="wrap-title">
										<h3 class="form-title">Create una cuenta</h3>
										<h4 class="form-subtitle">Información Personal</h4>
									</fieldset>									
									<fieldset class="wrap-input">
										<label for="frm-reg-lname">Nombres*</label>
										<input type="text" id="frm-reg-lname" name="name" placeholder="Nombres" :value="name" required autofocus autocomplete="name">
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Correo*</label>
										<input type="email" id="frm-reg-email" name="email" placeholder="Correo" :value="email">
									</fieldset>
									{{-- <fieldset class="wrap-title">
